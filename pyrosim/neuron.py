...
class NEURON:
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight_of_current_neuron, value_of_presynaptic_neruon):
        result = weight_of_current_neuron * value_of_presynaptic_neruon
